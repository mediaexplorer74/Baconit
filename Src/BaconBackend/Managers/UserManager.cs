...
namespace BaconBackend.Managers
{
    ...
    {        
        ...
        SmartWeakEvent<EventHandler<OnUserUpdatedArgs>> m_onUserUpdated
            = new SmartWeakEvent<EventHandler<OnUserUpdatedArgs>>();
        ...
        private async Task<SignInResult> InternalUpdateUser()
        {
            try
            {
                ...
                FireOnUserUpdated(lastUserName == CurrentUser.Name 
                    ? UserCallbackAction.Updated 
                    : UserCallbackAction.Added);
            }
            catch (Exception e)
            {
